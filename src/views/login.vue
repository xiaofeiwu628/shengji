  ...
  <div class="login-wrap">
    <el-form :model="formLogin"
      ...
      <el-form-item prop="Username" style="margin-bottom: 30px">
        <el-input v-model="formLogin.Username" placeholder="登录账号" autocomplete="off" @keydown.enter="submit">
          <template #prefix>
      ...
      <el-form-item prop="Password" style="margin-bottom: 30px">
        <el-input type="password" v-model="formLogin.Password" placeholder="登录密码" autocomplete="off" show-password @keydown.enter="submit">
          <template #prefix>
      ...
      <el-form-item prop="code">
        <el-row :span="24" type="flex" align="middle" style="margin-bottom: 30px">
          <el-col :span="14">
            <el-input v-model="formLogin.code" auto-complete="off" placeholder="请输入验证码" @keydown.enter="submit"></el-input>
          </el-col>
      ...
      <el-row style="text-align: center;margin-top: -10px;">
        <el-link type="primary" @click="toRegister" style="margin-left: 40%">用户注册</el-link>
      </el-row>
    </el-form>
  </div>
</template>
